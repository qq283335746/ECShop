...
{
    public class BbsContentType
    {
        private static readonly IBbsContentType dal = DataAccess.CreateBbsContentType();
        ...
        /// <param name="numberId"></param>
        /// <returns></returns>
        public BbsContentTypeInfo GetModel(string numberId)
        {
