<%@ Page Title="添加/修改内容类型" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AddContentType.aspx.cs" Inherits="TygaSoft.Web.Admin.AboutSite.AddContentType" %>
