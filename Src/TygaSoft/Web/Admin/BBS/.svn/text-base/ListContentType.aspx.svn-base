<%@ Page Title="内容类型列表" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ListContentType.aspx.cs" Inherits="TygaSoft.Web.Admin.BBS.ListContentType" %>
